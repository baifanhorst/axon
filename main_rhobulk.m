...
E1_st=4.84492636867872;
E2_st=1.15067058466895;
I1_st=0.329275546024855;
I2_st=0.263458360407258;
...
hopf_branch0=br_contn(funcs,hopf_branch0,1000);
...
[hopf_branch1,suc] = SetupHopf(funcs, stst_branch_wbifs, num_hopf(2),...
    'contpar', [ind_rhobulkK,ind_rhobulkD],...
    'dir', ind_rhobulkK, 'step', -0.001, parameter_bd{:});
hopf_branch1=br_contn(funcs,hopf_branch1,1000);